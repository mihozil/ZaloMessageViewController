...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    // need to determine the size of collectionViewLayout ..
    ZaloCollectionViewLayout *flowLayout = [[ZaloCollectionViewLayout alloc]init];

    ZaloMessageViewController *messageViewController = [[ZaloMessageViewController alloc]initWithCollectionViewLayout:flowLayout];
